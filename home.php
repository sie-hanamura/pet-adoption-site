...
<body>
    <main style="background-color: rgb(251, 245, 235);">
        ...
        <section class="featured-pets">
            ...
            <div class="pet-cards">
                <div class="pet-card">
                    <a href="adopt.php"><img src="resources/orange-cat.jpg" alt="Featured Pet 2"></a>
                    <h3>Lucy</h3>
                    <p>Orange Cat</p>
                    <a href="adopt.php" class="adopt-btn">Adopt Me</a>
                </div>
                <div class="pet-card">
                    <a href="adopt.php"><img src="resources\aspin-dog.jpg" alt="Featured Pet 1"></a>
                    <h3>Hulfy</h3>
                    <p>Aspin Dog</p>
                    <a href="adopt.php" class="adopt-btn">Adopt Me</a>
                </div>
                <div class="pet-card">
                    <a href="adopt.php"><img src="resources/labrador.jpg" alt="Featured Pet 3"></a>
                    <h3>Susu</h3>
                    <p>Labrador Dog</p>
                    <a href="adopt.php" class="adopt-btn">Adopt Me</a>
                </div>
